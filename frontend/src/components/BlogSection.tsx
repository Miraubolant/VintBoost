...
const blogPosts: BlogPost[] = [
  {
    ...
    excerpt: 'Découvre les secrets des top vendeurs pour booster tes ventes et attirer plus d\'acheteurs.',
    category: 'CONSEILS',
    readTime: '5 min',
  ...
  {
    id: '2',
    title: 'Comment créer des vidéos virales pour TikTok',
    excerpt: 'Les meilleures pratiques pour créer du contenu qui cartonne sur les réseaux sociaux.',
    category: 'TIKTOK',
    readTime: '4 min',
  ...
  {
    id: '3',
    title: 'Guide complet : photographier ses vêtements',
